    ...
    function removeItem(key, callback) {
        return new Promise(function(resolve, reject) {
            withStore('readwrite', function removeItemBody(store) {
                ...
                // scenario. See: https://github.com/mozilla/store/pull/67
                //
...
(function() {
    ...
    // See: https://github.com/mozilla/store/issues/68
    try {
    ...
    function setItem(key, value, callback) {
        return new Promise(function(resolve, reject) {
            ...
            // https://github.com/mozilla/store/pull/42
            if (value === undefined) {
                value = null;
            }
...
(function() {
    ...
    db.transaction(function (t) {
        t.executeSql('CREATE TABLE IF NOT EXISTS store (id INTEGER PRIMARY KEY, key unique, value)');
    });

    function getItem(key, callback) {
        return new Promise(function(resolve, reject) {
            db.transaction(function (t) {
                t.executeSql('SELECT * FROM store WHERE key = ? LIMIT 1', [key], function (t, results) {
    ...
    function setItem(key, value, callback) {
        return new Promise(function(resolve, reject) {
            ...
            // drivers. See: https://github.com/mozilla/store/pull/42
            if (value === undefined) {
                value = null;
            }
            ...
            if (typeof(value) === 'boolean' || typeof(value) === 'number' || typeof(value) === 'object') {
                // Mark the content as "store serialized content" so we
            ...
            db.transaction(function (t) {
                t.executeSql('INSERT OR REPLACE INTO store (key, value) VALUES (?, ?)', [key, valueToSave], function() {
                    if (callback) {
                        callback(value);
                    }
    ...
    function removeItem(key, callback) {
        return new Promise(function(resolve, reject) {
            db.transaction(function (t) {
                t.executeSql('DELETE FROM store WHERE key = ?', [key], function() {
                    if (callback) {
                        callback();
                    }
    ...
    function clear(callback) {
        return new Promise(function(resolve, reject) {
            db.transaction(function (t) {
                t.executeSql('DELETE FROM store', [], function(t, results) {
                    if (callback) {
                        callback();
                    }
    ...
    function length(callback) {
        return new Promise(function(resolve, reject) {
            db.transaction(function (t) {
                ...
                t.executeSql('SELECT COUNT(key) as c FROM store', [], function (t, results) {
    ...
    function key(n, callback) {
        return new Promise(function(resolve, reject) {
            db.transaction(function (t) {
                t.executeSql('SELECT key FROM store WHERE id = ? LIMIT 1', [n + 1], function (t, results) {
...
(function() {
    ...
    // The actual store object that we expose as a module or via a global.
    ...
    var store = {
        ...
        setDriver: function(driverName, callback) {
            return new Promise(function(resolve, reject) {
                if ((!indexedDB && driverName === store.INDEXEDDB) ||
                    (!window.openDatabase && driverName === store.WEBSQL)) {
                    if (callback) {
                        callback(store);
                    }
                ...
                // We allow store to be declared as a module or as a library
                ...
                if (moduleType === MODULE_TYPE_DEFINE) {
                    ...
                    store._extend(require('./' + driverName));
                    ...
                    store._extend(_this[driverName]);
