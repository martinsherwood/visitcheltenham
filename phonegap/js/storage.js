...
requireModule('promise/polyfill').polyfill();
    ...
    // previously exist), using any options set in window.storeConfig.
            ...
            this._ready = new Promise(function(resolve, reject) {
                ...
                if (moduleType === MODULE_TYPE_DEFINE) {
                    require([driverName], function(lib) {
                        ...
                        store._initStorage(window.storeConfig).then(function() {
                            if (callback) {
                                callback(store);
                            }
                    ...
                    var driver;
                    switch (driverName) {
                        case store.INDEXEDDB:
                            driver = require('store/src/drivers/indexeddb');
                            break;
                        case store.LOCALSTORAGE:
                            driver = require('store/src/drivers/localstorage');
                            break;
                        case store.WEBSQL:
                            driver = require('store/src/drivers/websql');
                    }
                    store._extend(driver);
