    ...
    onDeviceReady: function() {
		...
		(function() { //begin main map scope
			...
			$(function(placesMap) {
				...
				//draw polygon on the around the regents arcade geofence
				regentsArcadePoly = map.drawPolygon({
					paths: regentsArcadeFence,
					strokeColor: "#fff",
					strokeOpacity: 0,
					strokeWeight: 0,
					fillColor: "#fff",
				...
				//same for starbucks geofence
				starbucksPoly = map.drawPolygon({
					paths: starbucksFence,
					strokeColor: "#fff",
					strokeOpacity: 0,
					strokeWeight: 0,
					fillColor: "#fff",
							...
							success: function(position) {
								...
								map.addMarker({
									...
									outside: function(m, f) {
										console.log("Outside of Regents Arcade Geofence");
									},
									inside: function(m, f) {
										console.log("Inside of Regents Arcade Geofence");
									}
								});
